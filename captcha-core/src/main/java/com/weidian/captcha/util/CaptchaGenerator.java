...
public class CaptchaGenerator {
    ...
    public CaptchaImage generateImage() {
        ...
        // 一次画linenum条位置不一样的干扰线，分不同颜色，画linestimes次
        drawRandomLines(gd, linesNum, linesTimes);
     ...
     * @param linesTimes  干扰线画多少次
     * @param font       字体
     * @param fontHeight 字体高度
     */
    public CaptchaGenerator(int width, int height, int linesNum, int linesTimes, String font, int fontHeight) {
        this.width = width;
        this.height = height;
        this.linesNum = linesNum;
        this.linesTimes = linesTimes;
        this.font = font;
     ...
     * @param fontHeight 字体
     */
    public CaptchaGenerator(int width, int height, String font, int linesNum, int linesTimes, int MAX, int MIN, int fontHeight) {
        this.width = width;
        this.height = height;
        this.font = font;
        this.linesNum = linesNum;
    ...
    public int getLinesTimes() {
        return linesTimes;
    }

    public void setLinesTimes(int linesTimes) {
        this.linesTimes = linesTimes;
    }
